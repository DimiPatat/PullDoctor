...
def resolve_to_player(
    ...
    Use this anywhere an event's source or target needs to be attributed
    to "a raid member" rather than to whatever raw actor WCL logged.
    """
    if actor_id is None:
        return None
...
def resolve_to_player_id_name(
    ...
    resolution fails -- convenient for analyzers that want to keep
    something to display even for unresolvable pets/NPCs.
    """
